...
import com.ff.challenge.library.base.presentation.extension.asLiveData
...
abstract class BaseViewModel<ViewState : BaseViewState, ViewAction : BaseAction>(
    ...
    // (multiple states of the same type holding the same data will not be
    // dispatched multiple times to LiveData stream)
